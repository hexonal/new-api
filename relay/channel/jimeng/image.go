...
func jimengImageHandler(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo) (*dto.Usage, *types.NewAPIError) {
	...
	service.MaybeArchiveImageResponse(c.Request.Context(), info, fullTextResponse)
	service.SetLogImageResponse(c, fullTextResponse)
	jsonResponse, err := json.Marshal(fullTextResponse)
	if err != nil {
		return nil, types.NewError(err, types.ErrorCodeBadResponseBody)
	}
	service.SetLogOutputBodyBytes(c, jsonResponse)
