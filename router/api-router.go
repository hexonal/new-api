...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.PUT("/group_pricing", controller.UpdateGroupPricingOption)
		...
		logRoute.GET("/token/summary", middleware.AdminAuth(), controller.GetTokenSummary)
		logRoute.GET("/self/token/summary", middleware.UserAuth(), controller.GetSelfTokenSummary)

		dataRoute := apiRouter.Group("/data")
		dataRoute.GET("/", middleware.AdminAuth(), controller.GetAllQuotaDates)
		dataRoute.GET("/daily_user_usage_report", middleware.AdminAuth(), controller.GetDailyUserUsageReport)
